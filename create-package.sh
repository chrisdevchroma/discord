...
if [[ $distrib == "redhat" ]]; then
	...
	pkg_req='libatomic1, glibc, alsa, gconf2, libnotify, mozilla-nspr >= 4.13, mozilla-nss >= 3.27, libstdc++6, libX11-6 >= 1.6, libXtst6 >= 1.2, libappindicator3-1, libc++1, libXScrnSaver'
else
